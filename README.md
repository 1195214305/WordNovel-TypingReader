...
除了预设的工作文档，你还可以切换到自由输入模式，真正地打字输入自己的内容！
...
1. 按 **F2** 键进入自由输入模式
2. 在此模式下可以真正打字输入任意内容
3. 按 **Esc** 或再次按 **F2** 退出自由输入模式
4. 输入的内容会自动保存到浏览器本地存储
...
3. **自由输入模式** - 按F2可真正打字输入内容，在"假装工作"和"真正工作"间无缝切换
4. **沉浸体验** - 打字阅读的方式让阅读更有仪式感
5. **AI赋能** - 千问大模型一键生成各类小说，永不断更
6. **隐私保护** - API Key本地存储，边缘处理，安全可靠
